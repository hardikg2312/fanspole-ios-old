...
class LoginController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, LoginControllerDelegate {
    ...
    let pages: [Page] = {
        let firstPage = Page(title: "Manage Team Your Team", message: "Manage your team from anywhere on any network, with the interface designed specifically for phones", imageName: "manage_team")
        let secondPage = Page(title: "Join Leagues & Win Big", message: "Joining leagues now at your fingertips.", imageName: "leagues")
        let thirdPage = Page(title: "Compare Teams with others", message: "Compare other user teams and watch live changes", imageName: "gangs")
    ...
    lazy var pageControl: UIPageControl = {
        ...
        pc.currentPageIndicatorTintColor = UIColor(red: 31/255, green: 51/255, blue: 71/255, alpha: 1)
    ...
    lazy var skipButton: UIButton = {
        ...
        button.setTitleColor(UIColor(red: 31/255, green: 51/255, blue: 71/255, alpha: 1), for: .normal)
